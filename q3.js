function entradaDeDados(){
    let num1 = parseFloat(prompt("Digite sua primeira nota: "))
    let num2 = parseFloat(prompt("Digite sua segunda nota: "))
    let num3 = parseFloat(prompt("Digite sua terceira nota: "))
